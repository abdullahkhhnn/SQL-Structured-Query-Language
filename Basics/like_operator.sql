...
--Wildcards 
-- % sign (0,1 or multiple characters)
-- _ sign (it exactly represent only 1 character)
...
--12) Find Employees whose First Name has an 'a' in the third postion.
...
--15) Find Employees whose First Name does not start with a constant.
